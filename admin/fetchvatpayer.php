...
$columns = array( 'id', 'name', 'vat_id', 'vat_password', 'phone_number');

$query = "SELECT * FROM vat_payer_details ";
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<button type="button" name="update" class="btn btn-danger btn-xs update" id="'.$row["id"].'">Update</button>';
