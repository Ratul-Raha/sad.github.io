...
$columns = array( 'id', 'name', 'phone_number', 'email', 'email_pass', 'egp_pass', 'schedule_completion', 'payment_completion');

$query = "SELECT * FROM tenderer_details ";
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="email_pass">' . $row["email_pass"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="egp_pass">' . $row["egp_pass"] . '</div>';
